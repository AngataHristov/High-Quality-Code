namespace BangaloreUniversityLearningSystem.Utilities
{
    ...
    {
        public const string CourseLengthMsg = "The course name must be at least {0} symbols long.";
        public const string LectureLengthMsg = "The lecture name must be at least {0} symbols long.";
