namespace SharpCompiler
{
    ...
    {
        private readonly ICodeValidationStrategy validator;
        ...
        public CSharpCompiler(ICodeValidationStrategy validator)
        {
        ...
        public void Compile(string codeString)
        {
            ...
            this.compiledProgram = this.csharpCodeProvider
        ...
        {
            this.validator.Validate(codeString);
        }
    }
}
