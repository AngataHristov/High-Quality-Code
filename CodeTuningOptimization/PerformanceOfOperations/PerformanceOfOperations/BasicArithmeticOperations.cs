    ...
    public class BasicArithmeticOperations
    {
        ...
        public static void Main()
        {
            ...
            using (writer)
            {
                ...
                writer.WriteLine("Int: {0}", stopwatch.Elapsed);
                ...
                writer.WriteLine("Long: " + stopwatch.Elapsed);
                ...
                writer.WriteLine("Float: " + stopwatch.Elapsed);
                ...
                writer.WriteLine("Double: " + stopwatch.Elapsed);
                ...
                writer.WriteLine("Decimal: " + stopwatch.Elapsed);
                ...
                writer.WriteLine("Int: {0,10}", stopwatch.Elapsed);
                ...
                writer.WriteLine("Incrementation");
