    ...
    public class SortingAlgorithms
    {
        ...
        public static void Main()
        {
            ...
            using (writer)
            {
                ...
                writer.WriteLine("Quick Sort (Random Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Random Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Selection Sort (Random Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Quick Sort (Sorted Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Sorted Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Selection Sort (Sorted Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Quick Sort (Reversed Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Reversed Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Selection Sort (Reversed Int Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Quick Sort (Random Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Random Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Selection Sort (Random Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Quick Sort (Sorted Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Sorted Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Selection Sort (Sorted Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Quick Sort (Reversed Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Reversed Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Selection Sort (Reversed Double Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Quick Sort (Random String Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Random String Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Selection Sort (Random String Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Quick Sort (Sorted String Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Sorted String Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Selection Sort (Sorted String Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Quick Sort (Reversed String Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
                ...
                writer.WriteLine("Insertion Sort (Reversed String Values): " + stopwatch.Elapsed);
                stopwatch.Reset();
        ...
        private static void PerformInsertionSort<T>(T[] inputArray)
            where T : IComparable
        {
            for (int i = 1; i < inputArray.Length; i++)
            {
                ...
                for (int j = i - 1; j >= 0 && temp.CompareTo(inputArray[j]) == -1; j--)
                {
        ...
        private static void PerformSelectionSort<T>(T[] inputArray)
            where T : IComparable
        {
            int maxIndex = 0;
            ...
            for (int i = inputArray.Length - 1; i > 0; i--)
            {
                ...
                T temp = inputArray[maxIndex];
                inputArray[maxIndex] = inputArray[i];
                inputArray[i] = temp;
            }
        }

        private static void PerformQuickSort<T>(T[] inputArray, int start, int end)
            where T : IComparable
        {
            if (start < end)
            {
